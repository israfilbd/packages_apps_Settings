...
public class TopLevelBatteryPreferenceController extends BasePreferenceController
    ...
    private CharSequence generateLabel(BatteryInfo info) {
        ...
        int greenColor = ContextCompat.getColor(mContext, R.color.green_percentage);
        int orangeColor = ContextCompat.getColor(mContext, R.color.orange_percentage);
        int redColor = ContextCompat.getColor(mContext, R.color.red_percentage);
