...
public class TopLevelSettings extends DashboardFragment implements SplitLayoutListener,
    ...
    public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
        ...
        Preference infinitySuitePreference = screen.findPreference("top_level_infinity_suite");
        if (infinitySuitePreference != null) {
            screen.removePreference(infinitySuitePreference);
        }
        onSetPrefCard();
    }
